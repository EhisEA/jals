...
// ============================================================
  ...
  Future logOut() async {
    try {
      ...
      _hiveDB.deleteAllDB();
      locator<VideoAllViewModel>().clear();
      locator<VideoWatchLaterViewModel>().clear();
      locator<ArticleTrendingViewModel>().articles = null;
      locator<ArticleNewsViewModel>().news = null;
      locator<ArticleAllViewModel>().articles = null;
      locator<ArticleBookMarkedViewModel>().articles = null;
      locator<AudioAllViewModel>().audioList = null;
      locator<AudioPlaylistSectionViewModel>().playList = null;
      final DownloadService _downloadService = DownloadService();
      _downloadService.deleteAllDownloads();
      print("Done");
      await _navigationService.navigateToNewRoute(LoginViewRoute);
      print("Exit 0");
    } catch (e) {
      print(e);
    }
