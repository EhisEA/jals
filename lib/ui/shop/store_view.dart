...
class _StoreViewState extends State<StoreView> {
  ...
  Widget builRoundButton() {
    return Padding(
      ...
      child: Container(
        height: getProportionatefontSize(37.29),
        width: getProportionatefontSize(96),
        decoration: BoxDecoration(
            color: Color(0xffFCF7E4),
            borderRadius: BorderRadius.all(
              Radius.circular(23.8),
            )),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            SizedBox(width: 5),
            Image.asset("icons/plus_circle.png"),
          ],
        ),
      ),
    );
        ...
        child: selectedIndex != index
            ? Text(
                ...
                style: GoogleFonts.sourceSansPro(
                  ...
                  fontWeight: FontWeight.w600,
                  fontStyle: FontStyle.normal,
                  color: Color(0xff1F2230).withOpacity(.56),
                ),
              )
            : Padding(
