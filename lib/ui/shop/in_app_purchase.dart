...
const List<String> _kProductIds = <String>[_kConsumableId, "token2", "prop"];
...
class _MyAppState extends State<MyAppHome> {
  ...
  Future<bool> _verifyPurchase(PurchaseDetails purchaseDetails) async {
    ...
    //  BillingResultWrapper bill= await InAppPurchaseConnection.instance.completePurchase(purchaseDetails);
    // bill.debugMessage.
