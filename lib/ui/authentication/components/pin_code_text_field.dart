...
// selects the right fill color for the field
  ...
  Future<void> _showPasteDialog(String pastedText) async {
    ...
    DialogResponse f = await _dialogService.showConfirmationDialog(
      title: _dialogConfig.dialogTitle,
      description:
          _dialogConfig.dialogContent + " \n" + formattedPastedText + "?",
    );
    if (f.confirmed) {
      widget.controller.text = pastedText;
    }
