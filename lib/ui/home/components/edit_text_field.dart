...
enum EditTextFieldBorderType { none, roundLine, underLine }
...
class EditTextField extends StatefulWidget {
  ...
  final EditTextFieldBorderType borderType;
  final int maxLine;
  final int maxLength;
  ...
  const EditTextField({
    ...
    this.borderType = EditTextFieldBorderType.underLine,
    this.maxLine = 1,
    this.maxLength,
...
class _EditTextFieldState extends State<EditTextField> {
  ...
  Widget build(BuildContext context) {
    final Widget textField = TextField(
      ...
      decoration: InputDecoration(
        ...
        enabledBorder: getInputBorder(widget.borderColor),
        focusedBorder: getInputBorder(widget.focusBorderColor),
      ),
    ...
    if (widget.maxLine == null &&
        widget.borderType == EditTextFieldBorderType.roundLine) {
      return Container(
  ...
  Widget suffixView() {
    ...
    if (children.isNotEmpty) {
      if (widget.borderType == EditTextFieldBorderType.roundLine) {
        children.add(const SizedBox(width: 8));
      }
      return Container(
        child: Row(
  ...
  InputBorder getInputBorder(color) {
    final Color tempColor =
        color ?? Theme.of(context).primaryColor;
    if (widget.borderType == EditTextFieldBorderType.none) {
      print(1);
      return InputBorder.none;
    } else if (widget.borderType == EditTextFieldBorderType.roundLine) {
      print(2);
      if (widget.maxLine == null) {
        print(3);
    ...
    } else if (widget.borderType == EditTextFieldBorderType.underLine) {print(5);
